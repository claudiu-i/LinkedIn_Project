...
import { Layout, Avatar, Card, Button, Typography, Space, Flex, Menu, Input } from 'antd';
import Icon, { PlusOutlined, SearchOutlined, CaretDownOutlined } from '@ant-design/icons';
...
const LinkedInCard = ({
    ...
    return (
        <Card
            ...
            cover={
                <div style={{ position: 'relative', height: 80, backgroundImage: `url(${coverImageUrl})`, backgroundSize: 'cover' }}>
                    <div
                        style={{
                            position: 'absolute',
                            bottom: -36,
        ...
        >
            <div style={{ marginTop: 20 }}>
                <Meta
                    title={
                        <Typography.Title level={5} style={{ marginBottom: 0, fontSize: 18 }}>
                            {name}
                        </Typography.Title>
                    }
                    description={
                        <Space direction="vertical" size={1} style={{ width: '100%' }}>
                            <Text style={{ color: '#000', fontSize: 11, fontWeight: 600 }}>{role}</Text>
...
const LinkedInNavbar = () => {
    return (
        <div style={{
            ...
            {/* Left Section */}
            <Space size="small">
                <Typography.Link href="#" style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <div style={navItemStyle} onClick={() => { }}>
                    ...
                    <Text type="secondary" style={activeLabelStyle}>Home</Text>
                </div>
                <div style={navItemStyle} onClick={() => { }}>
                    <NetworkIcon style={iconStyle} />
                    <Text type="secondary" style={labelStyle}>My Network</Text>
                </div>
                <div style={navItemStyle} onClick={() => { }}>
                    <JobsIcon style={iconStyle} />
                    <Text type="secondary" style={labelStyle}>Jobs</Text>
                </div>
                <div style={navItemStyle} onClick={() => { }}>
                    <MessageIcon style={iconStyle} />
                    <Text type="secondary" style={labelStyle}>Messaging</Text>
                </div>
                <div style={navItemStyle} onClick={() => { }}>
                    <NotificationsIcon style={iconStyle} />
                    <Text type="secondary" style={labelStyle}>Notifications</Text>
                </div>
                <div style={navItemStyle} onClick={() => { }}>
                ...
                <div style={{ borderLeft: '1px solid #ddd', height: 40 }} />
                <div style={navItemStyle} onClick={() => { }}>
    ...
    <Layout style={layoutStyle}>
        ...
        <div style={divCenterStyle}>
            <Layout style={layoutCenterStyle}>
                <Sider width="225px" style={siderStyle} >
                    <Flex vertical gap='small'>
                        ...
                        >
                            ...
                            <a href={null} className='dummy-side' style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                                Profile viewers
                                <span style={{ color: "#0a66c2" }}>7</span>
                            </a>

                            {/* eslint-disable-next-line */}
                            <p><a href={null} className='dummy-side'>View all analytics</a></p>
                        </Card>
                ...
                <Content width="523px" style={contentStyle}>Content</Content>
                <Sider width="225px" style={siderStyle}>
                    Sider 2
                </Sider>
            </Layout>
